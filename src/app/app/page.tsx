...
const fadeUp = {
  ...
  animate: { opacity: 1, y: 0, transition: { duration: 0.7, ease: [0.25, 0.46, 0.45, 0.94] as const } },
};
...
export default function HomePage() {
  return (
    <>
      {/* ===== HERO (CSS animation, no JS dependency) ===== */}
          ...
          <div className="grid md:grid-cols-2 gap-4 mb-12">
            {[
              ...
              <motion.div
                ...
                className={`glass-card ${s.featured ? 'md:col-span-2 border-white/[0.12]' : ''}`}
              >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-12">
            {['五行香', '香薰蜡烛', '水晶手链', '运势月历'].map((cat, i) => (
              <motion.div
                ...
                className="glass-card aspect-square flex items-center justify-center text-center p-6"
              >
